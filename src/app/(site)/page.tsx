        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            {[{ title: 'Journal of Management' }, { title: 'Journal of Engineering' }].map(j => (
              <div
                key={j.title}
                className="rounded-2xl flex flex-col items-center justify-center py-16 text-white text-center"
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map(b => (
              <div key={b.title} className="bg-white rounded-xl p-6 text-center shadow-sm border border-gray-100">
                <div className="w-16 h-16 mx-auto mb-4 flex items-center justify-center rounded-xl overflow-hidden" style={{ background: '#e6f7f2' }}>
