  ...
  return (
    <>
      ...
      <section
        ...
        style={{ minHeight: '75vh', backgroundImage: 'url(/images/hero-bg.webp)', backgroundSize: 'cover', backgroundPosition: 'center' }}
      >
        <div className="absolute inset-0" style={{ background: 'rgba(5,30,25,0.62)' }} />
        <div className="relative z-10 max-w-3xl mx-auto px-6 py-24">
          <h1 className="text-4xl sm:text-5xl font-bold leading-tight mb-5">
            Advancing Medical Research with AI &amp; ML
          </h1>
          <p className="text-gray-200 text-base sm:text-lg mb-10 max-w-2xl mx-auto leading-relaxed">
          ...
          <Link href="/journal" className="inline-block px-10 py-3.5 border-2 border-white text-white font-semibold hover:bg-white hover:text-gray-900 transition-colors">
            Our Journals
          </Link>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="md:col-span-1 bg-white rounded-2xl border border-gray-200 shadow-sm p-6 flex gap-5">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mb-3 leading-relaxed">
                  is a peer-reviewed, open-access journal publishing high-quality research and innovations.
                </p>
            ...
            {[{ title: 'Journal of Management' }, { title: 'Journal of Engineering' }].map(j => (
              <div key={j.title} className="rounded-2xl flex flex-col items-center justify-center py-16 text-white text-center" style={{ background: '#0a5c3c' }}>
                <h3 className="text-xl font-bold mb-4">{j.title}</h3>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 flex flex-col relative overflow-hidden">
                ...
                <h3 className="font-bold text-gray-900 text-base mb-3 leading-snug">{article.title}</h3>
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-bold mb-10 text-gray-900">Why Publishing with Us</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map(b => (
              <div key={b.title} className="bg-white rounded-xl p-6 text-center shadow-sm border border-gray-100">
                <div className="w-16 h-16 mx-auto mb-4 flex items-center justify-center bg-blue-50 rounded-xl overflow-hidden">
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-gray-500 text-sm mb-10">Latest breakthroughs in AI-powered healthcare and medicine</p>
          <div className="flex flex-col md:flex-row gap-0 border border-gray-200 rounded-xl overflow-hidden">
            <div className="md:w-64 flex-shrink-0 border-r border-gray-200 bg-white">
              {newsTabs.map((tab, i) => (
                <button
                  key={tab.label}
                  onClick={() => setActiveTab(i)}
                  className={`w-full text-left px-5 py-4 text-sm border-b border-gray-100 transition-colors ${
                    i === activeTab ? 'font-bold text-gray-900 bg-gray-50 border-l-4 border-l-gray-900' : 'text-green-700 hover:bg-gray-50'
                  }`}
                >
                  {tab.label}
                </button>
            ...
            <div className="flex-1 p-8">
              <h3 className="text-lg font-bold text-gray-900 mb-3">{newsTabs[activeTab].title}</h3>
              <p className="text-gray-600 text-sm leading-relaxed mb-4">{newsTabs[activeTab].body}</p>
              <p className="font-bold text-gray-900 text-sm mb-3">Key Highlights:</p>
      ...
      >
        <div className="absolute inset-0" style={{ background: 'rgba(5,20,15,0.72)' }} />
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">Advancing Research in Medicine, Public Health &amp; AI</h2>
          <p className="text-gray-300 text-base mb-8 leading-relaxed max-w-2xl mx-auto">
            Tulitics is building the infrastructure for the next generation of open academic publishing — fast, transparent, and free for authors and readers alike.
          </p>
          <Link href="/journal/submit-an-article" className="inline-block px-8 py-3.5 border-2 border-white text-white font-semibold hover:bg-white hover:text-gray-900 transition-colors">
            Submit Your Article
          </Link>
        </div>
      </section>
      ...
      {/* DISCOVER BANNER */}
      <section className="py-14 px-6 text-white text-center" style={{ background: '#0a2e2e' }}>
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold mb-3">Discover +50,000 books, e-journals and journals</h2>
          <p className="text-green-200 mb-8">Amplify science, exchange perspectives and share experiences with the global research community.</p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/insights" className="px-7 py-3 font-semibold bg-white text-gray-900 hover:bg-gray-100 transition-colors">Explore Researcher Voices</Link>
            <Link href="/journal" className="px-7 py-3 font-semibold border-2 border-white text-white hover:bg-white/10 transition-colors">Visit Tulitics Shop</Link>
          </div>
        </div>
      </section>
    </>
