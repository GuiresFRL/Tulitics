    ...
    <>
      ...
      <section className="py-10 px-4 sm:px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <Link href="/insights/ai-precision-medicine-healthcare-delivery" className="group block rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow overflow-hidden mb-5">
              ...
              <div className="flex-1 p-6 flex flex-col justify-between">
                <div>
                  <div className="flex items-center gap-2 mb-3">
                    <span className="text-xs font-semibold px-3 py-1 rounded-full" style={{ background: 'rgba(124,58,237,0.12)', color: '#7c3aed' }}>Blog</span>
                    <span className="text-xs text-gray-400">📅 July 10, 2026</span>
                    <span className="text-xs text-gray-400">· 10 min read</span>
                  </div>
                  <h3 className="font-bold text-gray-900 text-lg leading-snug mb-3 group-hover:text-purple-800 transition-colors">
                    AI-Driven Innovations in Precision Medicine and Healthcare Delivery
                  </h3>
                  <p className="text-sm text-gray-600 leading-relaxed mb-4">
                    Discover how AI-driven precision medicine improves diagnostics, treatment decisions, and healthcare delivery systems. Explore real-world applications, implementation strategies, challenges, and future trends.
                  </p>
                  <div className="flex flex-wrap gap-1.5">
                    {['Precision Medicine', 'AI Healthcare', 'Genomics', 'Personalised Therapy'].map((kw) => (
                      <span key={kw} className="text-xs px-2 py-0.5 rounded-full bg-gray-100 text-gray-500">{kw}</span>
                    ))}
                  </div>
                </div>
                <div className="mt-4">
                  <span className="text-sm font-semibold" style={{ color: '#7c3aed' }}>Read article →</span>
                </div>
              </div>
            </div>
          </Link>
